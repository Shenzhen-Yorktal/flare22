...
def determine_postprocessing(base, gt_labels_folder, raw_subfolder_name="validation_raw",
    ...
    maybe_mkdir_p2(folder_all_classes_as_fg)
    maybe_mkdir_p2(folder_per_class)
    maybe_mkdir_p2(join(base, final_subf_name))
...
if __name__ == "__main__":
    inputs = [r'']
    for_which_classes = [1, 2, 3, 5, 13]
    for input in inputs:
        output = input + '-pped'
        for_which_classes = None
        apply_postprocessing_to_folder(input, output, for_which_classes)
